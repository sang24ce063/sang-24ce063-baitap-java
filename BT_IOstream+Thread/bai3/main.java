...
public class main {
    public static void main(String[] args) {
        String sourceFile = "C:\\Bài tập\\bt lập trình java\\Chương2\\BT_IOstream+Thread\\bai3\\file.txt"; 
        String destinationFile = "C:\\Bài tập\\bt lập trình java\\Chương2\\BT_IOstream+Thread\\bai3\\filecopy.txt"; 
