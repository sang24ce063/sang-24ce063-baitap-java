...
public class main {
    ...
    public static void main(String[] args) {
        String sourceFile = "C:\\Bài tập\\bt lập trình java\\Chương2\\BT_IOstream+Thread\\bai9\\file1.txt";
        String resultFile = "C:\\Bài tập\\bt lập trình java\\Chương2\\BT_IOstream+Thread\\bai9\\file2.txt";
